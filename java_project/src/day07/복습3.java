				...
				if(login) {
					...
					while(true) {
						...
						if(menu2 == 1) {
							...
							System.out.println("짜장면이 제공됩니다. 맛있게 드세요.");
							...
							System.out.println("짬뽕이 제공됩니다. 맛있게 드세요.");
							...
							System.out.println("탕수육이 제공됩니다. 맛있게 드세요.");
							...
							System.out.print("원하시는 금액을 입력해 주세요> ");
							int inMoney = sc.nextInt();
							balance[loginIndex]+=inMoney;
							System.out.printf("입금이 완료되었습니다. 현재 금액은 %d 원입니다.\n",balance[loginIndex]);
